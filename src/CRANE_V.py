...
app_ui = ui.page_navbar(
    ...
    ui.div(
        ...
        The goal of CRANE is to enhance the accuracy (with a cross-validation accuracy of 94%) and utility of craniometric population affinity estimation. 
        
        CRANE is trained on the Howells reference sample, which represents historical and pre-modern populations. 
        Because craniofacial morphology undergoes secular change, CRANE is intended for bioarchaeological and 
        population-historical research and is NOT validated for forensic casework involving modern decedents. 
...
Welcome to **CRANE (CRaniometric AffiNity Estimator)**, a UI-friendly application for estimating cranial population affinity using deep neural networks and craniometric measurements. 
...
2. The application will execute the following steps sequentially, each with a progress indicator:  
   ...
   2. **Population Affinity Estimation**: Predict population affinity probabilities using the model.  
...
- **Step 1** panel shows a table of population affinity probability predictions.  
...
Thank you for using `CRANE`. We hope this tool enhances your craniometric population affinity research!
    ...
    title = "Craniometric Affinity Estimator",  
